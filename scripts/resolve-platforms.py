...
ALL_PLATFORMS = [
    {
        ...
        "update_arch": "aarch64",
        "update_bundle": "macos",
        "update_archive_name": "workbuddy-switch-gw_{{version}}_macos-aarch64.app.tar.gz",
        "installer_names": "workbuddy-switch-gw_{{version}}_apple-arm64.dmg",
    },
    {
        "name": "macOS-x64",
        "os": "macos-14",
        ...
        "update_arch": "x86_64",
        "update_bundle": "macos",
        "update_archive_name": "workbuddy-switch-gw_{{version}}_macos-x86_64.app.tar.gz",
        "installer_names": "workbuddy-switch-gw_{{version}}_intel-x64.dmg",
    },
    {
        "name": "win-x64",
        "os": "windows-latest",
        ...
        "update_arch": "x86_64",
        "update_bundle": "nsis",
        "update_archive_name": "workbuddy-switch-gw_{{version}}_windows-x86_64-setup.exe",
        "installer_names": "workbuddy-switch-gw_{{version}}_windows-x86_64-setup.exe",
    },
    {
        "name": "linux-x64",
        "os": "ubuntu-24.04",
        ...
        "update_arch": "",
        "installer_names": "workbuddy-switch-gw_{{version}}_amd64.deb,workbuddy-switch-gw_{{version}}_amd64.AppImage",
    },
]
